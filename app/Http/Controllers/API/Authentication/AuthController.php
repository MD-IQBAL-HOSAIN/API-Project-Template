...
class AuthController extends Controller
{
    ...
    public function ProfileUpdate(Request $request)
    {
        ...
        return Helper::jsonResponse(true, 'Profile updated successfully', 200, $authenticatedUser->only(['name', 'email', 'avatar', 'role', 'phone', 'position', 'about', 'address', 'country', 'city', 'state', 'zip_code']));
    }
